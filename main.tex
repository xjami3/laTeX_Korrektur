...
Dich vorstellen, Ziel der Arbeit (kritische Analyse).

WICHTIG: Vertraulichkeit und Anonymisierung zusichern (DSGVO!).

Frage nach Erlaubnis zur Audio-Aufzeichnung (für Transkription).

Eisbrecher-Frage (z.B. "Beschreiben Sie kurz Ihre Rolle bei KS...").

Hauptteil (T-O-M-Fragen):

Hier folgt der Kern deines Leitfadens (siehe Beispiele unten).

Abschluss:

"Habe ich etwas Wichtiges vergessen zu fragen?"

"Was ist Ihr wichtigster Rat für andere Unternehmen, die Copilot einführen?"

Danken und Verabschiedung.




O Oli, weiterer organisator
Leitfaden für Gruppe O (Organisation / Projektleitung)
(O - Kotter Vision): "Was war das primäre strategische Ziel, das KS mit der Einführung von Copilot erreichen wollte?"

(O - Kotter Change): "Können Sie den Change- und Kommunikationsprozess beschreiben? Wie wurde die 'Vision' an die Mitarbeiter kommuniziert?"

(O - Governance): "Welche Governance-Struktur (z.B. ein CoE) wurde aufgesetzt, um den Rollout zu steuern?"

(O - KPIs): "Wie wird der Erfolg von Copilot gemessen? Schauen Sie nur auf Lizenzzahlen oder auch auf qualitative Aspekte?"

(M - FC): "Welche Trainings (Prompt Literacy) wurden angeboten und für wie wichtig wurden diese erachtet?"



T Maxi, Lukas lustermann
(T - Tech Hygiene): "Wie bewerten Sie den Zustand der 'Tech Hygiene' (Datenklassifizierung, Zugriffsrechte) bevor Copilot eingeführt wurde?"

(T - Purview): "Welche konkreten Maßnahmen (z.B. Microsoft Purview, DLP-Policies) wurden ergriffen, um das Risiko von Datenlecks (H2) zu minimieren?"

(T - Barrieren): "Was waren die größten technischen Hürden beim Rollout (z.B. Update-Kanäle, Latenz)?"

(M - Support): "Welche Art von Support-Anfragen erhalten Sie am häufigsten von Anwendern?" (Indikator für EE/Frustration).


M Justin Marlon 2 champions 1 abteilungsleiter
(M - PE): "Welchen Nutzen haben Sie sich von Copilot erhofft, als Sie davon hörten?"

(M - EE / H1): "Beschreiben Sie bitte eine Situation, in der Sie versucht haben, Copilot zu nutzen, das Ergebnis aber frustrierend oder nicht hilfreich war. Was ist passiert?"

(M - FC / H1): "Welche Schulungen zum Thema 'Prompting' haben Sie erhalten? Wie hilfreich waren diese, um gute Ergebnisse zu erzielen?"

(M - SI / H3): "Wie wird die Nutzung von Copilot in Ihrem Team wahrgenommen? Nutzt Ihre Führungskraft das Tool sichtbar?"

(M - Widerstand): "Welche Bedenken (z.B. Datenschutz, Qualität der Ergebnisse) haben Sie oder Ihre Kollegen bei der Nutzung?"

(T - GIGO / H2): "Wie oft kommt es vor, dass Copilot veraltete oder irrelevante interne Dokumente findet?"
